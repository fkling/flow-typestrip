...
module.exports = {
    'TypeAnnotations': {
        ...
        'a={set fooProp(value:number): void{}}': {
            ...
            transformed: 'a={set fooProp(value:number): voidfunction(value) {}}',
            eval: 'Unexpected token :',

        },
        'a={get fooProp(): number {}}': {
            raworiginal: 'a={get fooProp(): number {}}',
            transformed: 'a={get fooProp(): number function() {}}',
            eval: 'Unexpected token :',
    ...
    'Interfaces': {
        ...
        'class Foo extends class Bar implements Bat {} {}': {
            ...
            transformed: 'class Foo extends class Bar {} {}',
            eval: 'Unexpected reserved word',
